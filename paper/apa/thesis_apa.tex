...
The study utilizes a retrospective dataset of PTB patients from the Cordillera Administrative Region (CAR), Philippines, covering the period from 2015 to 2025. This dataset was acquired through a collaborative arrangement with a thesis team from the School of Nursing, Allied Health, and Biological Sciences (SONAHBS) Department of Pharmacy, who facilitated access to records consolidated by the Department of Health-CAR (DOH-CAR). Data is centrally consolidated by the Department of Health-CAR (DOH-CAR), which manages reports from government TB-DOTS facilities and private practitioners under the Public-Private Mix DOTS (PPMD) scheme \citep{ref6}.
