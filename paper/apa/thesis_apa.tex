...
% Uses: article class + natbib + apalike + manual APA formatting
% =============================================================================
...
% ----- Headers (APA: running head) -----
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
\renewcommand{\headrulewidth}{0pt}
\fancyhead[L]{\footnotesize TREATMENT PREDICTION USING ML FOR TB-DOTS}
\fancyhead[R]{\thepage}
...
% ----- References (APA-like with natbib) -----
...
\usepackage{caption}
\captionsetup{labelsep=newline, justification=centering, font=doublespacing, labelfont=bf}
...
\noindent\hspace{0.5in}Correspondence concerning this article should be addressed to Josephine S. Dela Cruz, DIT, Saint Louis University, Baguio City, Philippines. Email: \href{mailto:jdelacruz@slu.edu.ph}{jdelacruz@slu.edu.ph}
...
\begin{table}[htbp]
\centering
\caption{Test Set Model Performance}
