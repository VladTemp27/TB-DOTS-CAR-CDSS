...
\usepackage[a4paper,margin=1in,headheight=14.5pt]{geometry}
...
% ----- Prevent orphaned headings (heading stranded at page bottom with its
%       content starting on the next page). \keepwithnext reserves space before
%       a heading so it migrates to the next page if its body/float cannot
%       follow it here. Self-contained (no needspace package): probes the page
%       by briefly contributing the requested height; if it would overflow, the
%       earlier low penalty becomes the chosen breakpoint. Applied surgically at
%       the few headings that orphaned (see \keepwithnext calls in the body). -----
\makeatletter
\newcommand{\keepwithnext}[1]{%
  \penalty-100\begingroup\setlength\dimen@{#1}%
