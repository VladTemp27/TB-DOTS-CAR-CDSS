...
Pulmonary Tuberculosis (PTB) is a chronic infectious disease caused by \textit{Mycobacterium tuberculosis} (MTB), a slow-growing, acid-fast bacillus. Because the disease progresses gradually and treatment can fail, it remains hard to control \citep{ref20}. Effective therapies exist, but PTB is still widespread, largely because it tracks closely with poverty, undernutrition, and comorbidities such as diabetes and HIV that weaken immune defenses and raise susceptibility \citep{ref20}. These conditions also delay diagnosis and complicate treatment. TB remains one of the leading causes of death worldwide. In 2018, there were 10 million new cases and 1.5 million deaths, and about half a million of those cases were resistant to rifampicin.

In the Philippines, TB remains a major public health problem. The World Health Organization (WHO) lists the country among the top contributors to the global TB burden, with an estimated 6.8 percent of cases. Before the COVID-19 pandemic, Philippine TB rates were among the highest in Asia: over 554 cases per 100,000 people in 2019 \citep{ref8}. In 2023, about 37,000 Filipinos died of TB out of 739,000 diagnosed cases \citep{who2023tb}, and the WHO classifies the country as a high-burden setting for both MDR-TB and TB/HIV co-infection \citep{ref18}. The DOH recorded 575,770 TB cases that year through its Integrated TB Information System, a figure that points to substantial under-registration and underdiagnosis \citep{ref4}. The DOH applies CDC-recommended regimens for active and latent TB through the TB-DOTS strategy, which was expanded in 2003 to cover private clinics, pharmacies, and hospitals \citep{ref5, ref6}. Gaps in diagnosis, treatment monitoring, and patient support nonetheless remain, particularly in the management of MDR-TB \citep{ref29}.
...
Local conditions shape this burden as well. Baguio has a dense population and significant internal migration, and its cool, humid highland climate suits \textit{Mycobacterium tuberculosis} transmission. The city is also a tertiary referral center, so it receives complex cases from surrounding provinces and municipalities, which adds to the local caseload \citep{ref30}. Patient-level factors matter too. Diabetes mellitus, HIV infection, and malnutrition weaken immune response and lower treatment completion. Poverty-related barriers, including food insecurity, substandard housing, and transportation costs, disrupt adherence to directly observed treatment short-course (DOTS). On the system side, workforce shortages, unreliable drug supply chains, and fragmented referral networks limit how well services can keep up \citep{ref30,ref32,ref33,ref34}.

Taken together, these conditions argue for locally adaptive strategies that work on more than one front. Treatment failure does not only worsen outcomes for the individual patient. It also prolongs transmission in the community and accelerates the emergence of multidrug-resistant tuberculosis (MDR-TB), defined as resistance to at least rifampicin and isoniazid. MDR-TB requires regimens that are longer, more toxic, and more expensive, and it carries significantly lower success rates. The result is a wider threat to regional disease control in the Philippines \citep{ref28,ref35,ref36}.
\subsection{Risk Factors for Treatment Failure}

To allow consistent evaluation of TB control, the DOH has set standardized criteria for classifying treatment outcomes through the National Tuberculosis Program (NTP). Clear outcome definitions are needed for tracking program performance, comparing results across studies, and supporting risk factor analysis. Treatment success and failure are not random results; they reflect identifiable patient, clinical, and programmatic risk factors. Mortality is the main outcome used in most treatment-failure studies, though some also count disease progression, resistance to multiple anti-TB drugs, and loss to follow-up \citep{ref6}.
