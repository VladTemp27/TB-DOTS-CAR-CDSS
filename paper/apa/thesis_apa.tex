...
\shortcites{ref2,ref3,ref4,ref5,ref6,ref7,ref8,ref9,ref11,ref12,ref13,ref14,ref15,ref16,ref17,ref18,ref19,ref21,ref22,ref23,ref24,ref25,ref26,ref27,ref28,ref29,ref30,ref31,ref33,ref34,ref35,ref36,ref37,ref39,ref40,ref41,ref42,ref43,ref44,ref45,ref46,ref47}
=======
...
<<<<<<< HEAD
Beyond prediction, interpretability will be enhanced through the application of Shapley Additive Explanations (SHAP), a post-hoc interpretability technique grounded in additive feature attribution that quantifies how each variable contributes to a model prediction \citep{ref39}. Recent TB studies have used SHAP to make predictive models more clinically interpretable: SHAP-based XGBoost explanations identified key drivers of early treatment failure among patients with TB-diabetes comorbidity \citep{ref15}; SHAP was applied to rank individual risk factors for TB treatment non-adherence in a district-level cohort \citep{ref45}; biochemical-marker models used SHAP to highlight admission indicators associated with treatment discontinuation or failure \citep{ref46}; and HIV/TB co-infection outcome models used SHAP to relate model outputs to age, immune status, body-mass index, and other clinically meaningful features \citep{ref47}. These studies support the use of SHAP in this framework because it allows the proposed models to move beyond risk classification and show which demographic, clinical, diagnostic, and treatment-related variables most strongly influence predicted treatment success or failure. Using supervised learning with interpretable AI methods, the resulting models are designed to help healthcare providers identify patients at higher risk of treatment failure, enabling early intervention, tailored regimens, and improved patient management.
=======
