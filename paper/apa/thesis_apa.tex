...
\subsubsection*{Clinical Range Validation}

Every continuous clinical variable is checked against physiologically plausible bounds. Values outside these ranges are winsorized (clipped to the boundary) rather than discarded, preserving sample size while preventing extreme entry errors from distorting model training:
...
Weight & 10 kg & 180 kg \\
Height & 80 cm & 220 cm \\
Systolic blood pressure & 60 mmHg & 220 mmHg \\
Diastolic blood pressure & 30 mmHg & 140 mmHg \\
Heart rate & 20 bpm & 250 bpm \\
Respiratory rate & 4 breaths/min & 60 breaths/min \\
Temperature & 30$^\circ$C & 45$^\circ$C \\
Oxygen saturation & 70\% & 100\% \\
\midrule
\multicolumn{3}{l}{\footnotesize All continuous temporal variables (weight, adherence,} \\
\multicolumn{3}{l}{\footnotesize doses, smear and Xpert results) are similarly clipped.} \\
\bottomrule
\end{tabular}
\end{center}
